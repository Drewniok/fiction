    ...
    (cell_level_layout<sidb_technology, clocked_layout<hexagonal_layout<siqad::coord_t, even_column_hex>>>))
{
    ...
    CHECK(potential_SiDB_pair(distance_SiDB_pair(charge_layout, {0, 0, 0},{1, 0, 0})) == potential_SiDB_pair(distance_SiDB_pair(charge_layout, {0, 0, 0},{1, 0, 0})));
    CHECK(potential_SiDB_pair(distance_SiDB_pair(charge_layout, {0, 0, 0},{1, 0, 0})) == potential_SiDB_pair(distance_SiDB_pair(charge_layout, {1, 0, 0},{0, 0, 0})));
    CHECK(potential_SiDB_pair(distance_SiDB_pair(charge_layout, {1, 1, 1},{0, 0, 0})) < potential_SiDB_pair(distance_SiDB_pair(charge_layout, {0, 0, 0},{1, 0, 0})));
