...
using sidb_cell_clk_lyt_siq     = cell_level_layout<sidb_technology, clocked_layout<cartesian_layout<siqad::coord_t>>>;
using sidb_cell_clk_lyt_siq_ptr = std::shared_ptr<sidb_cell_clk_lyt_siq>;
